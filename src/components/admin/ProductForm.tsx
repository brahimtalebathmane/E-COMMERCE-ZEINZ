      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <section className="sm:col-span-2 space-y-4 rounded-xl border border-[var(--accent-muted)] bg-[var(--background)] p-4">
          <div>
            ...
            <p className="mt-1 text-xs text-[var(--muted)]">
              يظهر بين الأسئلة الشائعة وقسم جهات الاتصال كشريط أفقي مدمج مع زر واحد. الخلفية قابلة للتخصيص بالكامل من هنا دون تعديل الكود:
              لون ثابت، أو صورة بعرض الشاشة (رفع ملف أو لصق رابط URL)، مع منزلق الظل لتحسين تباين الزر على الصور.
            </p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-[var(--muted)]">
                تُعرض كخلفية الشريط بالكامل (تغطية كاملة للعرض). ارفع صورة أو الصق رابطاً مباشراً.
              </p>
              <input
                type="file"
                accept="image/*"
