...
export const adminAr = {
  ...
  analytics: {
    ...
    subtitle:
      "صافي الربح = إجمالي الإيرادات − (تكلفة البضاعة + الإنفاق الإعلاني). المرتجعات الداخلية تُستثنى تلقائياً من الإيرادات والتكلفة.",
    kpiGrossRevenue: "إجمالي الإيرادات",
    kpiGrossRevenueHint: "مجموع أسعار بيع الطلبات المؤكدة والمشحونة",
    kpiCogs: "تكلفة البضاعة (COGS)",
    kpiCogsHint: "تكلفة شراء الوحدات المباعة",
    kpiAdSpend: "الإنفاق الإعلاني",
    kpiAdSpendHint: "إجمالي رأس المال الإعلاني المُسجّل يدوياً",
    kpiNetProfit: "صافي الربح",
    kpiNetProfitHint: "الإيرادات بعد خصم التكلفة والإعلان",
    unitsSold: "وحدات مباعة",
    tableTitle: "الأرباح حسب المنتج",
    tableHint:
      "حرّر الإنفاق الإعلاني لكل منتج؛ تتحدث جميع المؤشرات فوراً دون إعادة تحميل الصفحة.",
    colProduct: "المنتج",
    colUnits: "وحدات",
    ...
    colReturns: "مرتجعات",
    adSpendPlaceholder: "0",
    save: "حفظ",
    saving: "جاري الحفظ…",
    saved: "تم تحديث الإنفاق الإعلاني",
    saveFailed: "تعذر حفظ الإنفاق الإعلاني",
    startDateHint:
    ...
    noData: "لا توجد بيانات أرباح بعد. ستظهر هنا عند تأكيد أول طلب.",
