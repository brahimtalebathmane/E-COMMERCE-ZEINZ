...
export const adminAr = {
  ...
  productForm: {
    ...
    sectionHeaderHint:
      "نص ترويجي لكل لغة تحت الشعار (اختياري). يمكنك ضبط عدد الأسطر الظاهرة وحجم الخط. إذا تركت الفرنسية فارغة يُعرض العربي في واجهة الفرنسية. «نداء الرأس» سطر إضافي تحته عند الحاجة.",
    headerBarArabic: "نص شريط الرأس — عربي",
    headerBarFrench: "Header bar — Français",
    headerBarMaxLinesLabel: "أقصى عدد أسطر للعرض",
    headerBarMaxLinesHint: "0 = إظهار النص كاملاً (بدون قص). من 1 إلى 12 يحدّ النص بنقاط عند تجاوز عدد الأسطر.",
    headerBarFontSizeLabel: "حجم خط الشريط (بكسل)",
    headerBarFontSizeHint: "اتركه فارغاً لاستخدام الحجم الافتراضي التلقائي على الهاتف والشاشات الكبيرة.",
    headerBarMaxLinesUnlimited: "كامل النص (بدون قص بالأسطر)",
    headerBarLinesMaxSuffix: "سطراً كحدّ أقصى",
    name: "الاسم",
    description: "الوصف",
    price: "السعر (MRU)",
