...
export function mapProductRow(row: Record<string, unknown>): ProductRow {
  ...
  return {
    ...
    hero_badge_ar: (row.hero_badge_ar as string) ?? "",
    hero_badge_fr: (row.hero_badge_fr as string) ?? "",
    ...
    offer_badge_ar: (row.offer_badge_ar as string) ?? "",
    offer_badge_fr: (row.offer_badge_fr as string) ?? "",
    offer_discount_text_ar: (row.offer_discount_text_ar as string) ?? "",
    offer_discount_text_fr: (row.offer_discount_text_fr as string) ?? "",
    offer_limited_text_ar: (row.offer_limited_text_ar as string) ?? "",
    offer_limited_text_fr: (row.offer_limited_text_fr as string) ?? "",
